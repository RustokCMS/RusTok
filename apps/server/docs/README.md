...
- Auth/RBAC observability: `/metrics` публикует `rustok_rbac_permission_cache_hits`, `rustok_rbac_permission_cache_misses`, `rustok_rbac_permission_checks_allowed`, `rustok_rbac_permission_checks_denied`, `rustok_rbac_claim_role_mismatch_total`, `rustok_rbac_decision_mismatch_total`, `rustok_rbac_shadow_compare_failures_total`, а также engine parity counters `rbac_engine_decisions_total`, `rbac_engine_mismatch_total`, `rbac_engine_eval_duration_ms` (compat aliases) plus canonical `rustok_rbac_engine_decisions_relation_total`, `rustok_rbac_engine_decisions_casbin_total`, `rustok_rbac_engine_mismatch_total`, `rustok_rbac_engine_eval_duration_ms_total`, `rustok_rbac_engine_eval_duration_samples`; consistency-gauges: `rustok_rbac_users_without_roles_total`, `rustok_rbac_orphan_user_roles_total`, `rustok_rbac_orphan_role_permissions_total`, `rustok_rbac_consistency_query_failures_total`, `rustok_rbac_consistency_query_latency_ms_total`, `rustok_rbac_consistency_query_latency_samples`.
