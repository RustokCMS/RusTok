...
- [`auth-release-gate-2026-03-04.md`](./auth-release-gate-2026-03-04.md) — финальные gate-артефакты Phase D по user/auth consistency remediation (integration, parity, security sign-off).
