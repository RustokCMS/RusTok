...
use crate::dto;
use crate::{available_locales_from, resolve_by_locale_with_fallback};
...
impl From<crate::entities::node::ContentStatus> for GqlContentStatus {
    fn from(status: crate::entities::node::ContentStatus) -> Self {
        match status {
            crate::entities::node::ContentStatus::Draft => GqlContentStatus::Draft,
            crate::entities::node::ContentStatus::Published => GqlContentStatus::Published,
            crate::entities::node::ContentStatus::Archived => GqlContentStatus::Archived,
        }
    }
}

impl From<GqlContentStatus> for crate::entities::node::ContentStatus {
    fn from(status: GqlContentStatus) -> Self {
        match status {
            GqlContentStatus::Draft => crate::entities::node::ContentStatus::Draft,
            GqlContentStatus::Published => crate::entities::node::ContentStatus::Published,
            GqlContentStatus::Archived => crate::entities::node::ContentStatus::Archived,
        }
    }
}
...
impl GqlNode {
    pub fn from_node_with_locale(
        ...
        Self {
            ...
            effective_locale,
            available_locales: available_locales_from(&node.translations, |translation| {
                &translation.locale
            }),
...
impl From<dto::NodeTranslationResponse> for GqlNodeTranslation {
    fn from(translation: dto::NodeTranslationResponse) -> Self {
        Self {
...
impl From<dto::BodyResponse> for GqlBody {
    fn from(body: dto::BodyResponse) -> Self {
        Self {
            locale: body.locale,
            body: body.body,
            format: body.format,
