...
impl ContentQuery {
    async fn node(
        ...
        match service.get_node(tenant_id, id).await {
            ...
            Err(crate::ContentError::NodeNotFound(_)) => Ok(None),
    ...
    async fn nodes(
        ...
        let (items, total): (Vec<crate::dto::NodeListItem>, u64) = service
