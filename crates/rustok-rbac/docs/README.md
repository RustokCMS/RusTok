...
- `casbin_shadow_evaluator` exports `evaluate_casbin_shadow` (matcher-compatible in-module enforcement for `single|any|all` checks), used by integration layers for parity shadow without changing active decision path.
