...
## Постоянные guardrails

Подробные постоянные правила вынесены в `docs/AI_CONTEXT.md` (раздел **«Постоянные guardrails для AI-генерации»**).
Здесь оставляем только pitfall-checklist, чтобы не дублировать инструкции между файлами.
