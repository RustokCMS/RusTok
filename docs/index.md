...
- [Server docs](../apps/server/docs/README.md) (includes mandatory/critical core modules baseline for agents (6 modules), Loco feature matrix, auth password-reset email delivery, dev seed behavior notes, and build-request event publication wiring, plus auth consistency Phase-D release gate report)
