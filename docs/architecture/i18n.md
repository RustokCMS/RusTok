...
- Remaining gaps are now limited to outbound email locale propagation and formalization of module-owned translation bundles.
...
### 4.1 HTTP locale runtime contract (April 2026)
